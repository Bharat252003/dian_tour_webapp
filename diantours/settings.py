"""
Django settings for diantours project.
...
WSGI_APPLICATION = 'diantours.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    # "search_model": ["auth.User", "auth.Group","dian.confirmbooking"],

    "topmenu_links": [

        # Url that gets reversed (Permissions can be added)
        {"name": "Home",  "url": "admin:index", "permissions": ["auth.view_user"]},
        {"name": "Packages",  "url": "/admin/dian/packages/", "permissions": ["auth.view_user"]},
        {"name": "Bookings",  "url": "/admin/dian/confirmbooking/", "permissions": ["auth.view_user"]},
    ...
    "hide_models": ["dian.packages","dian.confirmbooking","dian.contact","dian.payment"],
    ...
    "custom_links": {
        "dian": [{
            "name": "Packages", 
            "url": "/admin/dian/packages/", 
            "icon": "fas fa-cube",
            # "icon": "fa-solid fa-cube",
            "permissions": ["dian.view_dian"],
        },
        {
            "name": "Bookins", 
            "url": "/admin/dian/confirmbooking/", 
